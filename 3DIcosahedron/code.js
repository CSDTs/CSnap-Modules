console.log("loaded 3dprism code.js file");
...
StageMorph.prototype.addCoordinatePlane = function() {
  ...
  material = new THREE.LineBasicMaterial({
    color: 'red'  // previously black but will change this to red to see what will happen
  });
...
/**
 * inside this function we create our scene and our renderer (which in this is a canvas renderer)
 */
...
/**
 * below function renders the anishinaabe arch
 * @param width value passed in by the user
...
/**
 * below construction sets up the block space
 * @param category
 * @returns {Array}
 */
...
/**
 * supposed to turn camera on x axis
 * @param deg
 */
StageMorph.prototype.turnCameraAroundXAxis = function(deg) {
  ...
  this.changed();
  console.log("previous developer commented about this function not working properly")
};

/**
 * supposed to turn camera on y axis
 * @param deg
 */
...
// Previous non working attempt at exporting project as STL
// /**
