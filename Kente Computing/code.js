...
IDE_Morph.prototype.updateCorralBar = function () {
      ...
      MouseY < StageMorph.prototype.dimensions.y / -2) 
   {
     ...
     this.corralBar.children[2].text = "X: " + Math.round(this.stage.reportMouseX() / (coordinateScale * 1.369));
     this.corralBar.children[3].text = "Y: " + Math.round(this.stage.reportMouseY() / (coordinateScale * 0.733));
   }
